      ...
      <div class="ticket--center">
        <div class="ticket--center--row">
          ...
          <div class="ticket--center--col">
            ...
            <span class="ticket--info--content"> {{ @$data['id']}}</span>
          </div>
        </div>
        <div class="ticket--center--row">
          <div class="ticket--center--col">
            <span class="ticket--info--title">الميعاد</span>
            <span class="ticket--info--subtitle"> @if ($data['event'] ['id'] == 1)
                الخميس 10 نوفمبر 2022
            @else
            الجمعة 10 نوفمبر 2022

            @endif </span>
            <span class="ticket--info--content">{{ (int) $data['event_date']['time']}}:00 مساءً</span>
          </div>
          <div class="ticket--center--col">
        ...
        <div class="ticket--center--row">
          <div class="ticket--center--col">
            ...
            <span class="ticket--info--content">{{ @$data['type'] == 0 ? "افراد" : "مجموعة"}}</span>
          </div>
          <div class="ticket--center--col">
            <span class="ticket--info--title">رقم التذكرة</span>
            <span class="ticket--info--content"> {{@$data['ticket']['seat_number']}}</span>
          </div>
        </div>
      </div>
      <div class="ticket--end">
        <div>
            <img src="data:image/png;base64, {!! base64_encode( QrCode::size(100)->generate(route('pa' , 10))) !!}" />
